...
class _ImageInicioPageViewWidgetState extends State<ImageInicioPageViewWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TasksRecord>(
      stream: TasksRecord.getDocument(widget!.parameter3!),
        ...
        return InkWell(
          ...
          onTap: () async {
            if (_model.pageViewCurrentIndex ==
                functions.quantasNaLista(columnTasksRecord.photos.toList())) {
          ...
          child: Column(
            ...
            children: [
              Expanded(
                child: Builder(
                  builder: (context) {
                    final photos = columnTasksRecord.photos.toList();
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Image.asset(
                                                                                'assets/images/icons8-up-52.png',
                                                                                width: 200.0,
                                                                                height: 200.0,
                                                                                fit: BoxFit.cover,
                                                                              ),

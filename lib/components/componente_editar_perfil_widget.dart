...
class ComponenteEditarPerfilWidget extends StatefulWidget {
  /// crie um button shet com icon
  const ComponenteEditarPerfilWidget({super.key});

  @override
  State<ComponenteEditarPerfilWidget> createState() =>
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/icons8-waving-hand-emoji-96.png',
                  width: 59.2,
                  height: 55.2,
                  fit: BoxFit.cover,
                ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Flexible(
                          child: Text(
                            'There are a lot of people for you to meet, but let\'s set up your profile first.',
